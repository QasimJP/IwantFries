...
public class CoinsAnimation : MonoBehaviour
{
    ...
    public Transform[] moneyAnimationSources;
	...
	public int Coins {
		...
		set {
			...
			coinUIText.text = (PlayerPrefs.GetInt("TOTALCOINS")+Coins).ToString ();
		}
	}
    ...
    private void Start()
    {
        coinUIText.text = PlayerPrefs.GetInt("TOTALCOINS").ToString();
    }
